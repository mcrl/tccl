#!/bin/bash
mpirun -H a0:4,a1:4,a2:4,a3:4,a4:4,a5:4 -x LD_LIBRARY_PATH=$HOME/tmp/msccl-test/msccl/build/lib/:$LD_LIBRARY_PATH \
 -x NCCL_DEBUG=INFO \
 ...
 $HOME/tmp/msccl-test/nccl-tests/build/all_reduce_perf -b 128 -e 64MB -f 2 -g 1 -c 1 -n 10 -w 10 -G 10 -z 0
