...
mpirun -H $hosts -mca btl ^openib -mca pml ucx --bind-to none \
  ...
  -x TCCL_XML_FILE=/home/n1/heehoon/tccl-tools/akmu_a_tccl_routing_db.xml \
  -x LD_PRELOAD=/home/n1/heehoon/tccl/build/lib/libnccl.so \
  ./test-nccl-sendrecv $gpus

  #-x LD_LIBRARY_PATH=/home/n1/heehoon/tccl-exp/nccl-2.18.3-1/build/lib:$LD_LIBRARY_PATH \
  #-x LD_LIBRARY_PATH=/home/n1/heehoon/tccl/build/lib:$LD_LIBRARY_PATH \
  ...
  #/home/n1/heehoon/HPCX-Thunder/nccl-tests/build/all_reduce_perf \
