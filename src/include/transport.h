...
#define TRANSPORT_TCCL_P2P 4
#define TRANSPORT_TCCL_SHM 5
#define TRANSPORT_TCCL_NET 6
...
extern struct ncclTransport tcclP2pTransport;
extern struct ncclTransport tcclShmTransport;
extern struct ncclTransport tcclNetTransport;
